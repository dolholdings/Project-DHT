...
export const ProjectsView: React.FC = () => {
  ...
  const handleSaveProjectAsTemplateSubmit = (e: React.FormEvent) => {
    ...
    try {
      ...
      showToast(`Template "${createdTpl.name}" created with ${createdTpl.tasks.length} tasks & ${createdTpl.dependencies.length} dependencies!`);
    ...
    <div className={`p-3.5 sm:p-6 space-y-6 w-full max-w-[1700px] mx-auto animate-in fade-in ${theme === 'light' ? 'text-slate-800' : 'text-slate-100'}`}>
              ...
              >
                <div className="space-y-3">
                  ...
                  <div className="grid grid-cols-3 gap-2 py-2">
                    ...
                    <div className="p-2.5 rounded-xl bg-[#0D1520] border border-[#233549] text-center">
                      <div className="text-[10px] text-slate-500 font-mono uppercase">Est. Days</div>
                      <div className="text-sm font-bold text-white flex items-center justify-center gap-1 mt-0.5">
                ...
                <div className="pt-3 border-t border-[#233549] space-y-2">
                  <div className="flex items-center gap-2">
                    ...
                    <button
                      ...
                      className="p-2 rounded-xl bg-[#0D1520] hover:bg-[#233549] text-slate-300 hover:text-white border border-[#233549] transition-all"
                      title="Preview Template Tasks & Dependencies Structure"
                    >
      ...
      {showSaveTemplateModal && (
        <div className="fixed inset-0 z-50 bg-black/75 backdrop-blur-sm flex items-center justify-center p-4">
          <div className="bg-[#16222F] border border-[#233549] rounded-2xl w-full max-w-xl p-6 space-y-6 shadow-2xl animate-in zoom-in-95">
            ...
            <form onSubmit={handleSaveProjectAsTemplateSubmit} className="space-y-4 text-xs">
              ...
              <div className="p-3 rounded-xl bg-[#0773BB]/10 border border-[#0773BB]/30 text-slate-300 text-[11px] leading-relaxed flex items-start gap-2">
                ...
                <span>
                  All relative task durations, day offsets, subtasks, and Finish-to-Start dependency linkages from the selected project will be saved into the template library.
                </span>
              </div>
      ...
      {/* MODAL 3: PREVIEW TEMPLATE TASKS & DEPENDENCIES */}
      {previewTemplate && (
        <div className="fixed inset-0 z-50 bg-black/75 backdrop-blur-sm flex items-center justify-center p-4">
          <div className="bg-[#16222F] border border-[#233549] rounded-2xl w-full max-w-2xl p-6 space-y-5 shadow-2xl animate-in zoom-in-95 max-h-[85vh] flex flex-col">
            <div className="flex items-center justify-between border-b border-[#233549] pb-4 shrink-0">
              <div>
                <h2 className="text-lg font-bold text-white flex items-center gap-2">
                  <Eye className="w-5 h-5 text-[#3BC0BB]" />
                  <span>Template Task Structure & Dependency Graph</span>
                </h2>
            ...
            <div className="overflow-y-auto space-y-3 pr-1 text-xs">
              <div className="text-slate-300 font-semibold text-xs flex items-center justify-between">
                <span>Task Timeline Breakdown</span>
